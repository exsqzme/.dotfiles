return {
	...
	-- statusline
	{
		...
		config = function()
			...
			require("lualine").setup({
				...
				-- sections = { lualine_c = {"filetype"}, lualine_y = {}, },
				-- sections = { lualine_c = {"buffers"}, lualine_y = {}, },
	...
	-- lsp symbol navigation for lualine
	{
		...
		init = function()
			...
			require("exsqzme.util").on_attach(function(client, buffer)
		...
		opts = function()
			return {
				...
				highlight = true,
				depth_limit = 5,
				icons = require("exsqzme.config").icons.kinds,
			}
		end,
	},
